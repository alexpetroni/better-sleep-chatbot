...
CREATE TABLE IF NOT EXISTS "IntakeState" (
	...
	"state" json NOT NULL,
	"phase" varchar DEFAULT 'intake' NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "IntakeState" ADD CONSTRAINT "IntakeState_chatId_Chat_id_fk" FOREIGN KEY ("chatId") REFERENCES "public"."Chat"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
